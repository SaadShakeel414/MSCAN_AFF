# -*- coding: utf-8 -*-
"""
Created on Wed Jul 21 10:30:02 2021
...
class LocalNetwork(nn.Module):
    def __init__(self):
        ...
        self.fc = nn.Sequential(nn.Linear(in_features = 512*7*7,out_features = 64),nn.Tanh(),nn.Dropout(STN_Drop),nn.Linear(in_features = 64, out_features = 6),nn.Tanh(),)
    ...
    def forward(self, img):
        ...
        print(self.fc[3])
        grid = F.affine_grid(theta, torch.Size((batch_size, channels_x, height_grid, width_grid)))
...
def LResNet50E_IR_MSCAN_STN(is_gray=False):
