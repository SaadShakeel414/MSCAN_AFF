...
def get_val_data(data_path):
    ...
    return cplfw, cplfw_issame, calfw, calfw_issame, cfp_fp, cfp_fp_issame, lfw, lfw_issame, agedb_30, agedb_30_issame, cfp_ff, cfp_ff_issame, vgg2_fp, vgg2_fp_issame
