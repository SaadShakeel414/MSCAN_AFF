...
def main(source_root):
    ...
    dest_root = "E:/Deep_FR_AmSoftMax/Face_Identification_Experiments/LFW_Gallery_Probe/Probe_Masked/"
    mkdir(dest_root)
...
if __name__ == "__main__":
    min_side = 1
    main(source_root = "E:/Deep_FR_AmSoftMax/Face_Identification_Experiments/LFW_Gallery_Probe/Probe_Masked/")