...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help = "specify your source dir", default = "D:/image_to_align/", type = str)
    parser.add_argument("-dest_root", "--dest_root", help = "specify your destination dir", default = "D:/image_to_align/", type = str)
    ...
    for subfolder in tqdm(os.listdir(source_root)):
        ...
        for image_name in os.listdir(os.path.join(source_root, subfolder)):
            ...
            if image_name.split('.')[-1].lower() not in ['jpg', 'jpeg','png']: #not from jpg
